...
if($_SERVER['REQUEST_METHOD']=='GET')
{
	...
	$query="select startTime,endTime,outSendContent from outSendInfTable where outSendName='$outSendName' and isEnd='no'";
...
<div class="wrapper">
    <div class="row">
	<form action="assignOutSend.php" method="POST" target=_self>
            <table id="resumeList" class="table table-hover">
...
?>
				<tr>
					<td class="hidden"><input type="text" name="outSendName" value=<?php echo $outSendName;?>></td>
					<td class="text-center"><input type="checkbox" name="select[]" value=<?php echo $userId;?>></td>
...
else if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	{
		$query="insert into userToOutSend(userId,outSendName,interviewEvaluation) values('$i','$outSendName','no')";
		$result=mysqli_query($conn,$query)
				or die('Error querying database1'.mysqli_error());
...
<div class="wrapper">
    <div class="row">
			...
			<caption><h1 class="center">指派成功，当前外派人员情况如下</h1></caption>
                <thead>
                <tr>
