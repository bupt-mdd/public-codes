...
?>
	<div class="container">
    <div class="row">
	<form action="editEmployeeInf.php" method="POST" target=_self>
        <table class="table table-hover table-bordered">
		<caption><h1 class="center">员工信息</h1></caption>
		<tbody>
			<tr>
			<td class="col-sm-4">员工号：<label style="color:#FF0000">*</label></td>
			<td class="col-sm-8"><input type="text" placeholder="please input name" id="userId" class="form-control" name="userId" readonly="true" value=<?php echo $userId;?> required></td>
			</tr>
			<tr>
			...
			<td><input type="number" placeholder="please input ID number" id="IDNumber" class="form-control" name="IDNumber" value=<?php echo $IDNumber;?> required></td>
			</tr>
			<tr>
...
else if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	$query="update userInfTable set ".
	"name='$name',QQNumber='$QQNumber',IDNumber='$IDNumber',gender='$gender',email='$email',dateOfBirth='$dateOfBirth',phoneNumber='$phoneNumber',".
	"awards='$awards',eduBackground='$eduBackground',practiceExperience='$practiceExperience',personalAbility='$personalAbility' ".
	"where userId='$userId'";
